...
As described in the introduction chapter, polytope based representation of different physical abilities (physical ability polytopes) of humans and robots enables an accurate characterisation of their individual abilities. Furthermore, by expressing their individual abilities in the polytope form, their common abilities when collaborating can be computed using efficient polytope algebra operations and represented in polytope form as well. 
...
\Cref{ch:robot_metrics} brings an overview of the common polytope formulations for robotic manipulators, while \Cref{ch:human_metrics} presents the common metrics for humans, based on their miscalculate models. 
